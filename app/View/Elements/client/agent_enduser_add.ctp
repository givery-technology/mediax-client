	...
	<div class="col-lg-12">
		<div class="box">
			<div class="box-header" data-original-title="">
				<h2><i class="icon-user"></i><span class="break"></span><?php  echo __('Enduser Add');?></h2>
			</div>
			<div class="box-content">
				<?php echo $this->Form->create('Enduser'); ?>
					<div class="form-group">
					  <label class="control-label" for="date"><?php echo __('会社名'); ?></label>
					...
					<div class="form-group">
					  <label class="control-label" for="date"><?php echo __('顧客名'); ?></label>
					  <div class="controls row">
						<div class="input-group col-sm-4">
