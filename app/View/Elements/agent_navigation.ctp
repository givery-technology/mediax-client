...
<!-- home -->
			<li class="<?php echo $this->here==$this->webroot.'ranklogs/index'?'active':'' ?>">
				<a href="<?php echo $this->webroot?>ranklogs/index" class="title_link" ><i class="icon-home"></i><?php echo __('ホーム'); ?>&nbsp;</a>
			</li>
			
<!-- notice -->
			<li class="<?php echo $this->here==$this->webroot.'notices/index'?'active':'' ?>">
				<a href="<?php echo $this->webroot?>notices/index" class="title_link" ><i class="icon-bullhorn"></i><?php echo __('Notice'); ?>&nbsp;</a>
			</li>
			
<!-- keyword -->
			<li class="<?php echo $this->here==$this->webroot.'ranklogs/keyword'?'active':'' ?>">
				<a href="<?php echo $this->webroot?>ranklogs/keyword" class="title_link" ><i class="icon-align-justify"></i><?php echo __('キーワード詳細'); ?>
